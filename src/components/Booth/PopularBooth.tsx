        ...
        >
          <CardContent className="flex items-center p-0 w-full">
            <div className="flex items-center space-x-2 flex-1 min-w-0">
              ...
              <div className="ml-2 flex-1 truncate overflow-hidden whitespace-nowrap text-black text-xl font-pretendard">
                {booth.name}
              </div>
            </div>

            <div className="relative shrink-0 flex items-center space-x-2 mr-1 ml-3">
